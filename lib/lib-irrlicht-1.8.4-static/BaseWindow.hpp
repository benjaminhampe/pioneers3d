#ifndef DE_ALPHASONIC_GUI_BASE_WINDOW_HPP
#define DE_ALPHASONIC_GUI_BASE_WINDOW_HPP
...
namespace gui
{
	...
	class BaseWindow : public IGUIWindow
	{
	public:

		//! constructor
		BaseWindow(IGUIEnvironment* environment, IGUIElement* parent, s32 id, core::rect<s32> rectangle);
