...
//! constructor
BaseWindow::BaseWindow(IGUIEnvironment* environment, IGUIElement* parent, s32 id, core::rect<s32> rectangle)
...
void BaseWindow::refreshSprites()
{
	if (!Environment)
		return;
...
bool BaseWindow::OnEvent(const SEvent& event)
{
	if (isEnabled())
	{
...
void BaseWindow::updateAbsolutePosition()
{
...
IGUIButton* BaseWindow::getCloseButton() const
{
	return CloseButton;
}
...
IGUIButton* BaseWindow::getMinimizeButton() const
{
	return MinButton;
}
...
IGUIButton* BaseWindow::getMaximizeButton() const
{
...
bool BaseWindow::isDraggable() const
{
	return IsDraggable;
}
...
void BaseWindow::setDraggable(bool draggable)
{
...
void BaseWindow::setDrawBackground(bool draw)
{
	DrawBackground = draw;
}
...
bool BaseWindow::getDrawBackground() const
{
...
void BaseWindow::setDrawTitlebar(bool draw)
{
	DrawTitlebar = draw;
}
...
bool BaseWindow::getDrawTitlebar() const
{
	return DrawTitlebar;
}


void BaseWindow::updateClientRect()
{
	if (! DrawBackground )
	{
...
core::rect<s32> BaseWindow::getClientRect() const
{
	return ClientRect;
}
...
void BaseWindow::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options=0) const
{
...
void BaseWindow::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options=0)
{
