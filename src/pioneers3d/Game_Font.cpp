...
{
    //PRINT_FUNCTION_NAME
    for ( uint32_t i = 0; i < int32_t( game->Fonts.size() ); ++i )
    {
...
Game_createFonts( Game_t* game )
{
    ...
    Game_addFont( game, eFontType::FPS_COUNTER, "fonts/DroidSansFallbackFull.ttf", 32, true, true );
    Game_addFont( game, eFontType::H1, "fonts/DroidSansFallbackFull.ttf", 32, true, true );
