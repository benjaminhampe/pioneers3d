#ifndef PIONEERS3D_SCENE_CAMERA_HPP
#define PIONEERS3D_SCENE_CAMERA_HPP
...
inline irr::scene::ICameraSceneNode*
createCameraSceneNodeFPS( irr::scene::ISceneManager* smgr, irr::scene::ISceneNode* rootNode )
{
    ...
    irr::scene::ICameraSceneNode* cam = smgr->addCameraSceneNodeFPS( rootNode, 10.f,0.5f,-1,keyMap,6,false,1.0f, false, true );
...
#endif // PIONEERS3D_SCENE_CAMERA_HPP
